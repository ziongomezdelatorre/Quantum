...
INSERT INTO empleado (nombre, apellido, dni, fecha_nacimiento, correo, contraseña, direccion) VALUES
('Iker', 'Jiménez Soler', '47332109A', '2001-04-12', 'iker.js01@quantum.es', 'ikz_2001_secure', 'Calle de la Luna 14, Madrid'),
('Aitana', 'Vega Ortiz', '53884210B', '2003-08-25', 'aitana.vega@quantum.es', 'aitana_v03_pass', 'Avenida del Puerto 88, Valencia'),
('Mateo', 'Rivas Cano', '20993344C', '2000-01-15', 'mateo.rivas@quanmtum.es', 'm_rivas_genz', 'Calle Mayor 5, Barcelona'),
('Carla', 'Navarro Gil', '48221155D', '2002-11-30', 'c.navarro@quantum.es', 'carla_ng_2026', 'Calle Nueva 22, Sevilla'),
('Hugo', 'Pascual Sanz', '55110099E', '2005-05-20', 'hugo.p@quantum.es', 'hugo_p_work20', 'Plaza del Sol 3, Zaragoza');
...
INSERT INTO pedido (fecha, metodo_pago, estado, id_cliente) VALUES
('2026-04-10 10:30:00', 'tarjeta', 'entregado', 1), 
('2026-04-12 15:45:00', 'cripto', 'enviado', 2),    
('2026-04-14 09:00:00', 'transferencia', 'pendiente', 3),
('2026-04-15 12:20:00', 'tarjeta', 'pendiente', 2), 
('2026-04-15 17:05:00', 'cripto', 'pendiente', 1);  
