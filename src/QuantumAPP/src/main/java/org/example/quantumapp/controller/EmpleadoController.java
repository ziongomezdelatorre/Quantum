...
public class EmpleadoController implements Initializable {
    ...
    public void GUI() {
        ...
        colStock.setOnEditCommit(productoIntegerCellEditEvent -> {
            Producto producto = productoIntegerCellEditEvent.getRowValue();
            producto.setStock(productoIntegerCellEditEvent.getNewValue());
            actualizarProducto(producto);
        });
    }
}
